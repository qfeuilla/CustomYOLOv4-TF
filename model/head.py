...
def YOLOv4_head(input_data, NUM_CLASS, bbox_per_head=2):
    ...
    conv_small_box = cm.ConvBlock(conv_small_box, (3, 3, 256, bbox_per_head * (NUM_CLASS + 5)), activate=False, bn=False)
    ...
    conv_medium_box = cm.ConvBlock(conv_medium_box, (3, 3, 512, bbox_per_head * (NUM_CLASS + 5)), activate=False, bn=False)
    ...
    conv_big_box = cm.ConvBlock(conv_big_box, (3, 3, 1024, bbox_per_head * (NUM_CLASS + 5)), activate=False, bn=False)
